...
def create_graph_routes(rag, api_key: Optional[str] = None):
    ...
    async def get_popular_labels(
        ...
        Args:
            ...
            graph_tags (Optional[List[str]]): Optional graph_tag filters. Empty/omitted means no filtering.

        Returns:
            List[str]: List of popular labels sorted by degree (highest first)
        """
        try:
            return await rag.chunk_entity_relation_graph.get_popular_labels(limit, graph_tags)
        except Exception as e:
    ...
    async def search_labels(
        ...
        """
        try:
            return await rag.chunk_entity_relation_graph.search_labels(q, limit, graph_tags)
        except Exception as e:
